...
def calc_min_dimension(length, max_length, sqrt=math.sqrt):
	"""
	...
	other_length = sqrt(triangle_lengths_difference)

	return other_length

def calc_diagonal(width, depth, sqrt=math.sqrt):
	"""
	...
	hypotenuse = sqrt(width_depth_squared_sum)
